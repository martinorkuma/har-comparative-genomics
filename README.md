...
![HAR Comparative Genomic poster](docs/HAR_comp_genomics_poster_img.png)

> *Click for full resolution. PDF version: [docs/HAR_Genomic_poster.pdf](docs/HAR_comp_genomics_poster.pdf)*
